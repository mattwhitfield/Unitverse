namespace SentryOne.UnitTestGenerator.Core.Tests.Strategies.PropertyGeneration
{
    ...
    [TestFixture]
    public class MultiConstructorInitializedPropertyGenerationStrategyTests
    {
        private MultiConstructorInitializedPropertyGenerationStrategy _testClass;
        ...
        public void SetUp()
        {
            ...
            _testClass = new MultiConstructorInitializedPropertyGenerationStrategy(_frameworkSet);
        }

        [Test]
        public void CanConstruct()
        {
            var instance = new MultiConstructorInitializedPropertyGenerationStrategy(_frameworkSet);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new MultiConstructorInitializedPropertyGenerationStrategy(default(IFrameworkSet)));
        }

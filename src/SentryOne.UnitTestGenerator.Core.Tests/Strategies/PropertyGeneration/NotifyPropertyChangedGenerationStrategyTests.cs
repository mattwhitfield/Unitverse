namespace Unitverse.Core.Tests.Strategies.PropertyGeneration
{
    ...
    [TestFixture]
    public class NotifyPropertyChangedGenerationStrategyTests
    {
        private NotifyPropertyChangedGenerationStrategy _testClass;
        ...
        {
            var instance = new NotifyPropertyChangedGenerationStrategy(_frameworkSet);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new NotifyPropertyChangedGenerationStrategy(default(IFrameworkSet)));
        }
        ...
        {
            Assert.That(_testClass.IsExclusive, Is.EqualTo(true));
        }

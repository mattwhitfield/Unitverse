namespace SentryOne.UnitTestGenerator.Core.Tests.Strategies.PropertyGeneration
{
    ...
    [TestFixture]
    public class WriteOnlyPropertyGenerationStrategyTests
    {
        private WriteOnlyPropertyGenerationStrategy _testClass;
        ...
        public void SetUp()
        {
            ...
            _testClass = new WriteOnlyPropertyGenerationStrategy(_frameworkSet);
        }

        [Test]
        public void CanConstruct()
        {
            var instance = new WriteOnlyPropertyGenerationStrategy(_frameworkSet);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new WriteOnlyPropertyGenerationStrategy(default(IFrameworkSet)));
        }

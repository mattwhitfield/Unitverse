namespace Unitverse.Core.Tests.Helpers
{
    ...
    public class DetectedGenerationOptionsTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new DetectedGenerationOptions(default(IGenerationOptions), false, false, false, false, TestFrameworkTypes.XUnit, MockingFrameworkType.FakeItEasy));
        }
        ...
        public void CanGetFrameworkType()
        {
            ...
            instance = new DetectedGenerationOptions(_baseOptions, null, null, null, null, TestFrameworkTypes.NUnit2, null);
        ...
        public void CanGetMockingFrameworkType()
        {
            ...
            instance = new DetectedGenerationOptions(_baseOptions, null, null, null, null, null, MockingFrameworkType.NSubstitute);
        ...
        public void CanGetUseFluentAssertions()
        {
            ...
            instance = new DetectedGenerationOptions(_baseOptions, false, null, null, null, null, null);
            Assert.That(instance.UseFluentAssertions, Is.EqualTo(false));
            _baseOptions.UseFluentAssertions.Returns(false);
            instance = new DetectedGenerationOptions(_baseOptions, true, null, null, null, null, null);
            Assert.That(instance.UseFluentAssertions, Is.EqualTo(true));
        }

        [Test]
        public void CanGetUseShouldly()
        {
            _baseOptions.UseShouldly.Returns(true);
            var instance = new DetectedGenerationOptions(_baseOptions, null, null, null, null, null, null);
            Assert.That(instance.UseShouldly, Is.EqualTo(true));
            instance = new DetectedGenerationOptions(_baseOptions, null, false, null, null, null, null);
            Assert.That(instance.UseShouldly, Is.EqualTo(false));
            _baseOptions.UseShouldly.Returns(false);
            instance = new DetectedGenerationOptions(_baseOptions, null, true, null, null, null, null);
            Assert.That(instance.UseShouldly, Is.EqualTo(true));
        }
        ...
        public void CanGetUseAutoFixture()
        {
            ...
            instance = new DetectedGenerationOptions(_baseOptions, null, null, false, null, null, null);
            Assert.That(instance.UseAutoFixture, Is.EqualTo(false));
            _baseOptions.UseFluentAssertions.Returns(false);
            instance = new DetectedGenerationOptions(_baseOptions, null, null, true, null, null, null);
            Assert.That(instance.UseAutoFixture, Is.EqualTo(true));
        }
        ...
        public void CanGetUseAutoFixtureForMocking()
        {
            ...
            instance = new DetectedGenerationOptions(_baseOptions, null, null, null, false, null, null);
            Assert.That(instance.UseAutoFixtureForMocking, Is.EqualTo(false));
            _baseOptions.UseAutoFixtureForMocking.Returns(false);
            instance = new DetectedGenerationOptions(_baseOptions, null, null, null, true, null, null);
            Assert.That(instance.UseAutoFixtureForMocking, Is.EqualTo(true));
        }

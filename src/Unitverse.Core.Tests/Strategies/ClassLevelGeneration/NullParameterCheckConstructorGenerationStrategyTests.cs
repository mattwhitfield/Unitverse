namespace Unitverse.Core.Tests.Strategies.ClassLevelGeneration
{
    ...
    [TestFixture]
    public class NullParameterCheckConstructorGenerationStrategyTests
    {
        private NullParameterCheckConstructorGenerationStrategy _testClass;
        ...
        public void SetUp()
        {
            ...
            _testClass = new NullParameterCheckConstructorGenerationStrategy(_frameworkSet);
        }

        [Test]
        public void CanConstruct()
        {
            var instance = new NullParameterCheckConstructorGenerationStrategy(_frameworkSet);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new NullParameterCheckConstructorGenerationStrategy(default(IFrameworkSet)));
        }

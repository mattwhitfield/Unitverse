namespace Unitverse.Core.Tests.Strategies.ClassLevelGeneration
{
    ...
    [TestFixture]
    public class CanConstructSingleConstructorGenerationStrategyTests
    {
        private CanConstructSingleConstructorGenerationStrategy _testClass;
        ...
        {
            var instance = new CanConstructSingleConstructorGenerationStrategy(_frameworkSet);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new CanConstructSingleConstructorGenerationStrategy(default(IFrameworkSet)));
        }
